...
const contactLinks = [
  ...
  {
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" className="text-purple-400">
  ...
  {
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" className="text-blue-500">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#09090b] text-[#f4f4f5] bg-grid-pattern">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-6 py-12">
          ...
          {contactLinks.map((item, i) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-mono uppercase tracking-wider text-zinc-400 mb-0.5">
                  {item.label}
                </p>
                <p className="text-sm sm:text-base font-semibold text-white truncate group-hover:text-blue-400 transition-colors">
                  {item.value}
                </p>
              </div>
              <ArrowUpRight size={18} className="text-zinc-500 group-hover:text-blue-400 shrink-0" />
            </motion.a>
          ))}
        </div>

        {/* Resume Download CTA Banner */}
        <div className="glass-card p-8 flex flex-wrap items-center justify-between gap-6 mb-16 border-blue-500/30">
          <div>
            <h3 className="text-xl font-bold text-white mb-1 flex items-center gap-2">
              <FileText className="text-blue-400" /> Need my official resume?
            </h3>
          ...
          <a
            ...
            className="btn-solid py-2.5 px-6 font-mono text-xs"
          >
            Download Resume PDF
          </a>
        </div>
        ...
        <div className="space-y-8 pt-8 border-t border-zinc-800">
          <div>
            ...
            <h2 className="text-2xl font-bold text-white mt-1 flex items-center gap-2">
              <Code2 className="text-blue-400" /> 1,200+ Contributions & Streak
            </h2>
          </div>
        ...
        <div className="mt-14 glass-card p-6 border-zinc-800">
          <div className="flex items-center gap-2 mb-3 text-xs font-mono uppercase tracking-wider text-blue-400 font-bold">
