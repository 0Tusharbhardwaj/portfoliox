    ...
    >
      <div className="container">
        ...
        >
          ...
          >
            I&apos;m open to internship, collaboration, and full-time opportunities in software engineering, AI
            systems, and infrastructure. If you&apos;re building something interesting, reach out.
          </p>
            ...
            {links.map((link, i) => (
              ...
              >
                ...
                {(link.external || link.download) && (
                  <ArrowUpRight size={16} style={{ color: "#52525B" }} />
                )}
              </motion.a>
            ))}
          </div>
